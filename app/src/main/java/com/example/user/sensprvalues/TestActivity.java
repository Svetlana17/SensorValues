    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonStart.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                manager.registerListener(TestActivity.this, manager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER), 0);
                manager.registerListener(TestActivity.this, manager.getDefaultSensor(Sensor.TYPE_GYROSCOPE), 0);
